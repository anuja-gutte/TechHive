const quizData = [
  {
      ...
      options:  ["An algorithm that works by dividing the list into smaller sublists and merging them",
  ...
  },
  {
      ...
      options: [  "A sorting algorithm that builds the sorted list one element at a time",
  ...
  },
  {
      ...
      options:[ "It sorts the array in place without additional memory",
  ...
  },
  {
      ...
      options: [ "It performs inefficiently, requiring O(n²) time in all cases",
  ...
  },
  {
      ...
      options:  [  "Merge Sort requires less memory than Insertion Sort",
  ...
  },
  {
      ...
      options: [ "It is split into two halves repeatedly until single elements remain",
  ...
  },
  {
      ...
      options: ["It requires additional memory",
